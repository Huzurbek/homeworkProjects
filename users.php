...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
               <?php  $bd->display_flash_message('success');?>
            <div class="subheader">
 ...
 <!--Permession For Admin:--><?php if($admin){ ?>
        ...
        <!--Permession For Admin:--> <?php if($admin || $bd->is_author($user['id'],$person['id'])):?>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:<?php echo $person['phone_number'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i>  <?php echo $person['phone_number'];?></a>
                                <a href="<?php echo $person['email'];?>" class="mt-1 d-block fs-sm fw-400 text-dark">
